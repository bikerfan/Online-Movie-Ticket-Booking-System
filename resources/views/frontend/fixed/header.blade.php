               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4">
                     <div id="logo" class="logomobile">
                        <a href="{{route('webhome')}}"><img src="https://blockbusterbd.com/assets/web/img/logo.png" id="logoimg" alt="Blockbuster Cinemas" data-retina="true"></a>
                     </div>
                  </div>
